...
def analyze_data_quality(df, dataset_name):
    """
    Analyze data quality including missing values and basic statistics
    """
    print(f"\nData Quality Analysis for {dataset_name} dataset:")
...
def load_and_prepare_transactions():
    ...
    try:
        ...
        df['operation'] = df['operation'].fillna('UNKNOWN_OPERATION')
        df['k_symbol'] = df['k_symbol'].fillna('UNSPECIFIED_CATEGORY')

        # Analyze data quality
        analysis_results = analyze_data_quality(df, 'Transaction')
...
def save_processed_data(df):
    ...
    df.to_parquet('/content/drive/MyDrive/SP3-Caterpillar/processed_transactions.parquet')
